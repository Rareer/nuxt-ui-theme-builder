...
import { useComponentConfigStore } from './componentConfig';
import { useThemeStore } from './theme';
import { useUiStore } from './ui';
import type { ComponentsConfig } from './componentConfig';
	...
	actions: {
		saveTheme(name: string) {
			...
			const snapshot: SavedThemeSnapshot = {
				...
				componentConfig: JSON.parse(JSON.stringify(componentConfig.exportConfig())),
				theme: {
		...
		async loadTheme(name: string) {
			...
			try {
				...
				componentConfig.importConfig(snapshot.componentConfig);
