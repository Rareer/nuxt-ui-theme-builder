...
export type ThemeVariable = 'primary' | 'secondary' | 'neutral' | 'success' | 'info' | 'warning' | 'error';
export const THEME_VARIABLES: ThemeVariable[] = ['primary', 'secondary', 'neutral', 'success', 'info', 'warning', 'error'];
