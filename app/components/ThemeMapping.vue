	...
	<div class="space-y-10">
		...
		<div class="space-y-6">
			<h2 class="text-xl font-bold">
				{{ t('themeMapping.assignTitle') }}
			</h2>
			<p class="text-sm text-neutral-500">
				{{ t('themeMapping.assignDesc') }}
			</p>
		...
		<div class="space-y-6">
			<h2 class="text-xl font-bold">
				{{ t('themeMapping.cssTitle') }}
			</h2>
			<p class="text-sm text-neutral-500">
				{{ t('themeMapping.cssDesc') }}
			</p>
			<div
				v-for="(variables, category) in cssVariablesByCategory"
				:key="category"
				class="mb-8"
			>
